...
class Note {
    ...
    static get style() { return ".sc-ion-note-ios-h{color:var(--color);font-family:var(--ion-font-family,inherit)}.ion-color.sc-ion-note-ios-h{color:var(--ion-color-base)}.sc-ion-note-ios-h{--color:var(--ion-text-color-step-650,#a6a6a6)}"; }
    static get styleMode() { return "ios"; }
}
