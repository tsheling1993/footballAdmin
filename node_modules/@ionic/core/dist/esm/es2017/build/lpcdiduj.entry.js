...
class Note {
    ...
    static get style() { return ":host{color:var(--color);font-family:var(--ion-font-family,inherit)}:host(.ion-color){color:var(--ion-color-base)}:host{--color:var(--ion-text-color-step-650,#a6a6a6)}"; }
    static get styleMode() { return "ios"; }
}
